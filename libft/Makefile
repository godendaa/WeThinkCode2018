...
OPTION = -c
SRC = ft_atoi.c ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c \
	...
	ft_putnbr.c ft_putendl.c ft_putstr.c ft_putchar.c ft_strsplit.c ft_itoa.c \
	ft_putnbr_fd.c ft_putendl_fd.c ft_putstr_fd.c ft_putchar_fd.c

OBJ = ft_atoi.o ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o \
	...
	ft_putnbr.o ft_putendl.o ft_putstr.o ft_putchar.o ft_strsplit.o ft_itoa.o \
